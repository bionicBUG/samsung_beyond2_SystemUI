...
.method public constructor <init>()V
    ...
    .line 105
    iput v2, p0, Landroid/app/enterprise/ManagedAppInfo;->mControlStateDisableCause:I
...
.method public readFromParcel(Landroid/os/Parcel;)V
    ...
    iput p1, p0, Landroid/app/enterprise/ManagedAppInfo;->mIsInstallSourceMDM:I
...
.method public toString()Ljava/lang/String;
    ...
    iget p0, p0, Landroid/app/enterprise/ManagedAppInfo;->mAppUninstallationDisabled:I
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 169
    iget-object p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mAppPkg:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 170
    iget p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mAppInstallCount:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 171
    iget p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mAppUninstallCount:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 172
    iget p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mAppDisabled:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 173
    iget p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mAppInstallationDisabled:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 174
    iget p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mAppUninstallationDisabled:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 175
    iget p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mControlStateDisableCause:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 177
    iget-object p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mControlStateDisableCauseMetadata:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 178
    iget p2, p0, Landroid/app/enterprise/ManagedAppInfo;->mIsEnterpriseApp:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 179
    iget p0, p0, Landroid/app/enterprise/ManagedAppInfo;->mIsInstallSourceMDM:I
