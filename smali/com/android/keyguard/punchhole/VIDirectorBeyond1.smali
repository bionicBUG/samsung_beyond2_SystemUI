...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const v0, 0x3f662b6b    # 0.8991f

    const v1, 0x3cf9096c    # 0.0304f

    invoke-direct {p1, v0, v1}, Landroid/graphics/PointF;-><init>(FF)V

    iput-object p1, p0, Lcom/android/keyguard/punchhole/VIDirectorBeyond1;->mCameraLocPercent:Landroid/graphics/PointF;

    .line 32
    new-instance p1, Landroid/graphics/PointF;

    const v0, 0x3de76c8b    # 0.113f

    const v1, 0x3d7487fd    # 0.0597f

    invoke-direct {p1, v0, v1}, Landroid/graphics/PointF;-><init>(FF)V

    iput-object p1, p0, Lcom/android/keyguard/punchhole/VIDirectorBeyond1;->mFaceVISizePercent:Landroid/graphics/PointF;
...
.method protected getCameraLocationRatio()Landroid/graphics/PointF;
    ...
    .line 40
    iget-object p0, p0, Lcom/android/keyguard/punchhole/VIDirectorBeyond1;->mCameraLocPercent:Landroid/graphics/PointF;
...
.method public getFaceRecognitionVIFileName()Ljava/lang/String;
    ...
    const-string p0, "face_unlocking_cutout_ic_whitebg_b1.json"

    goto :goto_0

    :cond_0
    const-string p0, "face_unlocking_cutout_ic_b1.json"
...
.method protected getFaceRecognitionVISizeRatio()Landroid/graphics/PointF;
    ...
    .line 50
    iget-object p0, p0, Lcom/android/keyguard/punchhole/VIDirectorBeyond1;->mFaceVISizePercent:Landroid/graphics/PointF;
