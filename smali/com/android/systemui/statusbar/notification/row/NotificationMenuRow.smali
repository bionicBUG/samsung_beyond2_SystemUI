...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationFreeformMenuItem;
    }
.end annotation
...
.method public static createFreeformItem(Landroid/content/Context;)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    .locals 4
    ...
    .line 352
    sget v1, Lcom/android/systemui/R$string;->recents_split_button_description:I
    ...
    .line 353
    sget v1, Lcom/android/systemui/R$drawable;->sec_notification_popup:I

    .line 354
    new-instance v2, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationFreeformMenuItem;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v0, v3, v1}, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationFreeformMenuItem;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/systemui/statusbar/notification/row/NotificationGuts$GutsContent;I)V
...
.method static createInfoItem(Landroid/content/Context;Z)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    ...
    sget v2, Lcom/android/systemui/R$layout;->sec_notification_info:I
    ...
    check-cast v1, Lcom/android/systemui/statusbar/notification/row/SecNotificationInfo;
...
.method private createMenuViews(ZZ)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mShowSnooze:Z

    if-nez p2, :cond_1

    .line 295
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mShowSnooze:Z
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mSnoozeItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mAppOpsItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    invoke-static {v0, v2}, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->createInfoItem(Landroid/content/Context;Z)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    ...
    invoke-static {v0, v2}, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->createSecInfoItem(Landroid/content/Context;Z)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    ...
    invoke-static {v0}, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->createFreeformItem(Landroid/content/Context;)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->supportFreeform(Landroid/service/notification/StatusBarNotification;)Z
    ...
    .line 323
    iget-boolean p2, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mShowSnooze:Z
...
.method static createSecInfoItem(Landroid/content/Context;Z)Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow$NotificationMenuItem;
    .locals 5
    ...
    .line 805
    sget p1, Lcom/android/systemui/R$drawable;->quickpanel_ic_setting:I
...
.method static createSnoozeItem(Landroid/content/Context;)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    .line 782
    sget v1, Lcom/android/systemui/R$string;->notification_menu_snooze_description:I
    ...
    sget v2, Lcom/android/systemui/R$layout;->sec_notification_snooze:I
...
.method private setAppName(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    instance-of v5, v5, Lcom/android/systemui/statusbar/notification/row/SecNotificationInfo;

    if-eqz v5, :cond_0

    .line 557
    sget v4, Lcom/android/systemui/R$string;->notification_settings_icon_description:I
    ...
    instance-of v5, v5, Lcom/android/systemui/statusbar/notification/row/SecNotificationSnooze;

    if-eqz v5, :cond_1

    .line 560
    sget v4, Lcom/android/systemui/R$string;->snooze_icon_description:I
...
.method private setMenuLocation()V
    ...
    .line 649
    iget v5, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mIconPadding:I
    ...
    iget v7, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mIconPadding:I
...
.method protected getSpaceForMenu()I
    ...
    iget p0, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mIconPadding:I
...
.method public isChangedSnoozeSetting()Z
    .locals 3
    ...
    .line 274
    :goto_0
    iget-boolean p0, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mShowSnooze:Z
...
.method public supportFreeform(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-virtual {v1}, Lcom/android/systemui/util/SettingsHelper;->isNotificationLaunchFreeformEnabled()Z
    ...
    const-string p0, "!isFreemformEnabled"
    ...
    const-string v0, "intent is not Activity"
    ...
    .line 382
    new-instance v4, Lcom/android/systemui/ActivityIntentHelper;

    iget-object p0, p0, Lcom/android/systemui/statusbar/notification/row/NotificationMenuRow;->mContext:Landroid/content/Context;

    invoke-direct {v4, p0}, Lcom/android/systemui/ActivityIntentHelper;-><init>(Landroid/content/Context;)V

    const/4 p0, 0x1

    .line 383
    invoke-virtual {v4, v1, v0, p0}, Lcom/android/systemui/ActivityIntentHelper;->getTargetActivityInfo(Landroid/content/Intent;IZ)Landroid/content/pm/ActivityInfo;
    ...
    const-string/jumbo v0, "unresizable : "
