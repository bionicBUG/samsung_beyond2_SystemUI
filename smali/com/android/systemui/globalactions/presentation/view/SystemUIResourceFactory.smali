...
.method public get(Lcom/samsung/android/globalactions/presentation/view/ResourceType;)I
    ...
    sget p0, Lcom/android/systemui/R$id;->sec_global_actions_side_cover_background:I

    return p0

    .line 25
    :cond_e
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->ID_SIDE_COVER_TEXT:Lcom/samsung/android/globalactions/presentation/view/ResourceType;

    if-ne p1, p0, :cond_f

    sget p0, Lcom/android/systemui/R$id;->sec_global_actions_side_cover_text:I

    return p0

    .line 26
    :cond_f
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->ID_SIDE_COVER_TEXT_BACKGROUND:Lcom/samsung/android/globalactions/presentation/view/ResourceType;

    if-ne p1, p0, :cond_10

    sget p0, Lcom/android/systemui/R$id;->sec_global_actions_side_cover_text_background:I

    return p0

    .line 27
    :cond_10
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->ID_SIDE_COVER_ICON:Lcom/samsung/android/globalactions/presentation/view/ResourceType;

    if-ne p1, p0, :cond_11

    sget p0, Lcom/android/systemui/R$id;->sec_global_actions_side_cover_icon:I
    ...
    .line 44
    :cond_1f
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->DRAWABLE_SIDE_COVER_POWER_OFF_BG:Lcom/samsung/android/globalactions/presentation/view/ResourceType;
    ...
    .line 45
    :cond_20
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->DRAWABLE_SIDE_COVER_POWER_OFF_ICON:Lcom/samsung/android/globalactions/presentation/view/ResourceType;
    ...
    .line 47
    :cond_22
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->DRAWABLE_SIDE_COVER_RESTART_BG:Lcom/samsung/android/globalactions/presentation/view/ResourceType;
    ...
    .line 48
    :cond_23
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->DRAWABLE_SIDE_COVER_RESTART_ICON:Lcom/samsung/android/globalactions/presentation/view/ResourceType;
    ...
    .line 52
    :cond_27
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->DRAWABLE_BIKEMODE:Lcom/samsung/android/globalactions/presentation/view/ResourceType;

    if-ne p1, p0, :cond_28

    sget p0, Lcom/android/systemui/R$drawable;->tw_ic_do_bikemode_square:I
    ...
    .line 62
    :cond_31
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->DRAWABLE_SETTING_MTRL:Lcom/samsung/android/globalactions/presentation/view/ResourceType;

    if-ne p1, p0, :cond_32

    sget p0, Lcom/android/systemui/R$drawable;->tw_ic_ab_setting_mtrl:I
    ...
    .line 72
    :cond_39
    sget-object p0, Lcom/samsung/android/globalactions/presentation/view/ResourceType;->DIMEN_SIDE_COVER_RIGHT_MARGIN:Lcom/samsung/android/globalactions/presentation/view/ResourceType;

    if-ne p1, p0, :cond_3a

    sget p0, Lcom/android/systemui/R$dimen;->sec_global_actions_side_cover_right_margin:I
