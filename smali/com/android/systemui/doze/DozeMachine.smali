...
.method private transitionPolicy(Lcom/android/systemui/doze/DozeMachine$State;)Lcom/android/systemui/doze/DozeMachine$State;
    ...
    invoke-virtual {v0}, Lcom/android/systemui/doze/DozeMachine$State;->canMOD()Z
    ...
    const-string v1, " because current state is MOD : "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/systemui/doze/DozeMachine;->mMODReason:I
...
.method protected requestState(Lcom/android/systemui/doze/DozeMachine$State;)V
    .locals 1
