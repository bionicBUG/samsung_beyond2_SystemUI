...
.method public semSetDozeScreenBrightness(II)V
    ...
    .line 40
    invoke-super {p0, p1, p2}, Lcom/android/systemui/doze/DozeMachine$Service$Delegate;->semSetDozeScreenBrightness(II)V

    .line 41
    iget-object p0, p0, Lcom/android/systemui/doze/DozeBrightnessHostForwarder;->mHost:Lcom/android/systemui/doze/DozeHost;

    invoke-interface {p0, p2}, Lcom/android/systemui/doze/DozeHost;->setDozeScreenBrightness(I)V
