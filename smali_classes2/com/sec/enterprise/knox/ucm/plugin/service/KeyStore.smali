.class public Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;
...
# direct methods
.method private constructor <init>(Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;Ljava/security/Provider;Ljava/lang/String;)V
    .locals 0
    ...
    .line 38
    iput-object p3, p0, Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;->algorithm:Ljava/lang/String;

    .line 39
    iput-object p1, p0, Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;->spiImpl:Ljava/security/KeyStoreSpi;

    .line 40
    iput-object p2, p0, Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;->provider:Ljava/security/Provider;

    return-void
.end method

.method public static getInstance(Ljava/lang/String;Ljava/security/Provider;)Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;
    .locals 2
    ...
    .line 51
    const-class v0, Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;
    ...
    check-cast v0, Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;

    if-eqz v0, :cond_0

    .line 56
    new-instance v1, Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;

    invoke-direct {v1, v0, p1, p0}, Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;-><init>(Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;Ljava/security/Provider;Ljava/lang/String;)V
...
.method public aliases()Ljava/util/Enumeration;
    ...
    .line 87
    iget-object p0, p0, Lcom/sec/enterprise/knox/ucm/plugin/service/KeyStore;->spiImpl:Ljava/security/KeyStoreSpi;
...
.method public getErrorStatus()I
    ...
    instance-of v0, p0, Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;

    if-eqz v0, :cond_0

    .line 70
    check-cast p0, Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;

    .line 71
    invoke-virtual {p0}, Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;->getErrorCode()I
...
.method public setProperty(Landroid/os/Bundle;)V
    ...
    .line 62
    invoke-virtual {p0, p1}, Lcom/sec/enterprise/knox/ucm/plugin/agent/UcmAgentProviderImpl$UcmAgentKeyStoreSpi;->setProperty(Landroid/os/Bundle;)V
